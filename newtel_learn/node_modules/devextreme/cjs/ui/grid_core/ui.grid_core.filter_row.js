...
var ColumnHeadersViewFilterRowExtender = function() {
    ...
    return {
        ...
        _handleDataChanged: function(e) {
            var _e$operationTypes;
            this.callBase.apply(this, arguments);
            if (null !== (_e$operationTypes = e.operationTypes) && void 0 !== _e$operationTypes && _e$operationTypes.filtering) {
        ...
        updateLookupDataSource: function() {
            ...
            var columns = this.getController("columns").getVisibleColumns();
            var dataSource = this.getController("data").dataSource();
            var filterRowController = this.getController("applyFilter");
            ...
            columns.forEach((function(column) {
                ...
                var $cell = _this2._getCellElement(rowIndex, column.visibleIndex);
                var editor = getEditorInstance($cell.find(".dx-editor-container"));
                filterRowController.setCurrentColumnForFiltering(column);
                var filter = _this2.getController("data").getCombinedFilter();
                filterRowController.setCurrentColumnForFiltering(null);
                var lookupDataSource = _uiGrid_core2.default.getWrappedLookupDataSource(column, dataSource, filter);
                null === editor || void 0 === editor ? void 0 : editor.option("dataSource", lookupDataSource)
            }))
        },
            ...
            headerPanel: {
                ...
                optionChanged: function(args) {
                    if ("filterRow" === args.name) {
                        this._invalidate();
                        args.handled = true
                    } else if ("syncLookupFilterValues" === args.name) {
                        var _this$component$getVi;
                        null === (_this$component$getVi = this.component.getView("columnHeadersView")) || void 0 === _this$component$getVi ? void 0 : _this$component$getVi.updateLookupDataSource();
                        args.handled = true
                    } else {
                        this.callBase(args)
                    }
